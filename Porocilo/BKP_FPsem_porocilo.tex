...
kjer so $a$, $c$ in $d$ celoštevilske vrednosti in $a$, $c$, $d$, $\underline{b}$ in $\overline{b}$ nenegativne. V najini nalogi so z
	...
	Sliki 3 in 4 prikazujeta varianco podatkov uporabljenih na primerih iz prejšnjega odstavka. Vidimo lahko, da je za večji $y$ ta večja, pri manjših pa zelo blizu 0.
