...
% VIRI	
		...
		\addcontentsline{toc}{section}{Literatura}
			...
			\bibitem{Brotcorne,Hanafi,Mansi2009} Brotcorne, L.; Hanafi, S.; Mansi, R. (2009). \textit{A dynamic programming algorithm for the bilevel knapsack problem} CountryXX: Elsevier.
